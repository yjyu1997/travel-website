...
import com.heyu.travel.basic.ListData;
import com.heyu.travel.basic.MapData;
import com.heyu.travel.basic.SingleData;
import com.heyu.travel.service.RedisCacheService;
import com.heyu.travel.session.*;
 ...
 * 		删除redis中的缓存
 * 添加:
 * 		不需要做任何缓存操作(因为我们不确定新增的数据是否要立即使用)
 */
@Log4j2
@Service
public class RedisCacheServiceImpl implements RedisCacheService {
    ...
    public void tryRateLimiter(String key) {
        ...
        //keyHandler的值：findUserByid:10101011:sdfsdf-sdfsdf-sdfsdfsd-sdfs__rate_limiter
